package it.imolinfo.client.samples;
...
import it.imolinfo.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@it.imolinfo.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
