...
- demo-multi-module-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- demo-multi-module-ui: main application module, development time
- demo-multi-module-production: module that produces a production mode WAR for deployment
